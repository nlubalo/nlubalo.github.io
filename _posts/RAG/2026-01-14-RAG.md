...
1. #### Data Collection and Ingestion
   ...
   Raw wikipedia articles contain alot of extra information that is not relevant to our use case.
   I use a pattern matching regular expressions and spacy to clean the text. The entire notebook with this implementation can be found [here](https://github.com/nlubalo/wikipedia_QnA/blob/main/src/load_wikipedia_corpus.ipynb).
